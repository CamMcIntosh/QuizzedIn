...
<?php printSignInSignUpForms(); ?>
	...
	<div class="sub-nav">
		<div class="sub-nav-item">
			...
			<button class="sub-nav-item-button"> <a class="sub-item-link" href="./signUp.php" style="text-decoration:none"><span>Sign Up</span></a> </button> 
		</div>
		<div class="sub-nav-item">
			<div class="sub-nav-item-title">
				Look Up Categories 
			...
			<button class="sub-nav-item-button"> <a class="sub-item-link" href="./categories.php" style="text-decoration:none"><span>Go to Category</span></a> </button> 
		</div>
		<div class="sub-nav-item">
			<div class="sub-nav-item-title">
				Create New Quiz 
			...
			<button class="sub-nav-item-button"> <a class="sub-item-link" href="./createQuiz.php" style="text-decoration:none"><span>Create Quiz</span></a> </button> 
		</div>
	</div>
</div>
